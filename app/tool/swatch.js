...
class Swatch extends React.Component {
  ...
  handleRemoveColor (color) {
    this.props.dispatch({ type: 'removeColour', color: this.props.color })
  }
    ...
    return (
      <div className="fl w-25 w-25-m w-10-ns mr0-m mb0-m mr1-ns mb1-ns relative">
        <div className="aspect-ratio aspect-ratio--1x1 br0-ns br2-ns overflow-hidden z-0 relative">
          <div className="aspect-ratio--object cover" style={{backgroundColor: this.props.color.rgbString()}}></div>
        </div>
